...
void main() {
  group('UserModel', () {
    ...
    test('toJson includes avatar key even when null', () {
      final user = UserModel(
        username: 'testuser',
        avatarUrl: null,
      );
      ...
      // The toJson includes the key with null value
      expect(json.containsKey(UserFields.avatarUrl), true);
      expect(json[UserFields.avatarUrl], isNull);
    });
  });
}
