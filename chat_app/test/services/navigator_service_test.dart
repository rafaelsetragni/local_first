...
void main() {
  group('NavigatorService', () {
    ...
    test('navigateToChat does not throw when called', () {
      final service = NavigatorService();
      ...
      // This should not throw even without navigator state
      expect(() => service.navigateToChat(chat), returnsNormally);
    });
    ...
    testWidgets('navigateToChat with active navigator state initiates navigation', (tester) async {
      final service = NavigatorService();
      final chat = ChatModel(
        id: 'chat1',
        name: 'Test Chat',
      ...
      // Call navigateToChat - it should call push
